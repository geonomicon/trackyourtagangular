...
angular.module('trackyourtagangularApp')
  .controller('MainCtrl', ["$location", "$scope", "myService", "Restangular", function ($location,$scope,myService, Restangular) {
    this.awesomeThings = [
      'HTML5 Boilerplate',
      'AngularJS',
      'Karma'
...
angular.module('trackyourtagangularApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/main.html',
    "<div class=\"jumbotron\"> <h1>Track Your Tag</h1> <p><button class=\"button\" ng-click=\"login('google')\">Google Login</button></p> </div>"
  );
